    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                {!!Form::textarea('description', isset($post) ? $post->description : old('description'), ['class' => 'form-control editor-ckeditor', 'placeholder' => ''] ) !!}
            ...
            <div class="form-group">
                <a href="{{url('backend/'.$post_type.'s')}}" class="btn btn-warning">Cancel</a>
                @if(isset($post))
